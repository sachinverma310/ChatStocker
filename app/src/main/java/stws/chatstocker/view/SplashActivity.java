...
//        Prefrences.Companion.saveInt(this, ConstantsValues.KEY_Noti_RADIO_ID,0);
//        printHashKey();
//        setContentView(R.layout.activity_splash);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode==REQUEST_PERMISION_CODE &&grantResults.length == 7&& grantResults[0] == PackageManager.PERMISSION_GRANTED
